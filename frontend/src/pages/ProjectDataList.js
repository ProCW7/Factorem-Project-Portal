...
export class ProjectDataList extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <PageBase title="List of Projects" navigation="Projects /">
              ...
              return (
                <TableRow className={classes.row} key={data.name}>
                  ...
                  <CustomTableCell>
                    {(data.status === "waiting") ? (
                      <React.Fragment>
                        <Button  className={classes.button} variant="contained" color="secondary" component={Link} to={"/UpdatedStatusProjects?id="+data.projects_id+"&s=a"}>
                          Approve
                        </Button>
                        <Button  className={classes.button} variant="contained" component={Link} to={"/UpdatedStatusProjects?id="+data.projects_id+"&s=r"}>
                          Reject
                        </Button>
                      </React.Fragment>
                    ) : (data.status === "approved") ? (
                      <React.Fragment>
                        <Button  className={classes.button} variant="contained" color="primary" component={Link} to={"/UpdatedStatusProjects?id="+data.projects_id+"&s=d"}>
                          Deliver
                        </Button>
                      </React.Fragment>
                    ) : (null)}
...
export default withStyles(styles)(ProjectDataList);